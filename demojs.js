...
//ham goi lai:la ham duoc truyen vao 1 khac nhu tham so
...
//vong lap for
var danhsachNhom10=["Mầu Văn Minh","Lê Minh Xuân","Trung","Huy"];

for(let i=0;i<danhsachNhom10.length;i++){
    console.log(danhsachNhom10[i]);
}
